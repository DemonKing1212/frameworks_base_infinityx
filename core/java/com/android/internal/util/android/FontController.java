...
public class FontController {
    ...
    private Typeface getOverrideTypefaceInternal(String fontToOverride) {
        ...
        final boolean customFontPickerActive = isCustomFontPickerActiveInternal();
        ...
        final Set<String> overrideFonts = customFontPickerActive
                ? LEGACY_OVERRIDE_FONTS : OVERRIDE_FONTS;
        final Set<String> sysOverrideFonts = customFontPickerActive
